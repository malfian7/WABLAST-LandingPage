...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('#list01', { style: 'fade-left', speed: 1500, intensity: 5, threshold: 3, delay: 500, stagger: 625, staggerSelector: ':scope ul > li, :scope ol > li', replay: false });
		...
		onvisible.add('#image13', { style: 'fade-left', speed: 1500, intensity: 5, threshold: 3, delay: 0, replay: false });
		...
		onvisible.add('#text09', { style: 'fade-down', speed: 1500, intensity: 5, threshold: 3, delay: 500, replay: false });
